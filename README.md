...
# May need to reboot after installing Docker

# Use a temporary directory, or any other if preferred
cd $env:temp

# Clone the tester code
git clone https://github.com/cbsch/log4j-scan.git
...
@(
	"127.0.0.1:80",
	"127.0.0.1:443"
) | % { docker run log4j-scan -u http://$_ }
```
